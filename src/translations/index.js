...
export const translations = {
  en: {
    ...
    language: "Language",
    account: "Account",
    memorizeOrder: "Memorize the correct order",
    watchSymbolSequence: "Watch the symbol sequence carefully",
    recreateFromMemory: "Recreate the sequence from memory",
    ...
    backToTests: "Back to Tests",
    mystaraLine1: "🔮 Greetings, young seeker! I am Mystara, guardian of the Ancient Symbols.",
    mystaraLine2: "✨ These mystical runes hold the power of memory and concentration.",
    mystaraLine3: "🌟 Your quest is to observe the sacred sequences and recreate them perfectly.",
    mystaraLine4: "🎭 Are you ready to unlock the secrets of the Symbol Realm?",
    ...
    goodEffort: "Good effort! The cave's secrets are within your reach.",
    keepPracticing: "Keep practicing! Every echo you hear makes you stronger.",
    testResults: "Test Results",
    memoryTestCompleted: "The Auditory Sequential Memory Test is complete.",
    yourScore: "Your Score",
    forwardSequences: "Forward Sequences",
    reverseSequences: "Reverse Sequences",
    accuracy: "Accuracy",
    ...
    rewardEarned: "You've earned a reward!",
    memoryMasterTrophy: "The Memory Master Trophy",
    returnToResults: "Return to Results",
    ...
    dialog_5:
      ...
      riverLine1: "🐚 Hello, young traveler! I am Kaalnath, the crab who guards the River of Time.",
    riverLine2: "🌊 Here, the river flows not just through space but through moments long past and yet to come.",
    riverLine3: "⏳ Your challenge is to arrange the events of time in the right order.",
  ...
  ta: {
    ...
    you_said: "நீங்கள் சொன்னது",
    correct: "சரி",
    not_quite_try_next: "முழுமையாக சரியில்லை! அடுத்ததை முயற்சிப்போம்.",
    lets_try_next_one: "அடுத்ததை முயற்சிப்போம்!",
    challenge_complete: "சவால் முடிந்தது",
    forward_score: "நேர்முறை மதிப்பெண்",
  ...
  hi: {
    ...
    account: "खाता",
    word: "शब्द",
    memorizeOrder: "सही क्रम को याद करें",
    watchSymbolSequence: "प्रतीकों के क्रम को ध्यान से देखें",
    recreateFromMemory: "स्मृति से क्रम को दोहराएं",
    mystaraLine1: "🔮 नमस्ते, युवा साधक! मैं मिस्टारा हूँ, प्राचीन प्रतीकों की रक्षक।",
    mystaraLine2: "✨ ये रहस्यमय प्रतीक स्मृति और एकाग्रता की शक्ति को संजोए हुए हैं।",
    mystaraLine3: "🌟 तुम्हारा लक्ष्य है इन पवित्र क्रमों को ध्यानपूर्वक देखना और बिल्कुल वैसा ही दोहराना।",
    mystaraLine4: "🎭 क्या तुम प्रतीक लोक के रहस्यों को उजागर करने के लिए तैयार हो?",
    ...
    backToPreviousPage: "पिछले पृष्ठ पर वापस जाएं",
     riverLine1: "🐚 नमस्ते, युवा यात्री! मैं कालनाथ हूँ, वह केकड़ा जो समय की नदी की रक्षा करता है।",
    riverLine2: "🌊 यहाँ नदी केवल स्थान से नहीं, बल्कि अतीत और भविष्य के क्षणों से होकर बहती है।",
    riverLine3: "⏳ तुम्हारी चुनौती है समय की घटनाओं को सही क्रम में लगाना।",
    riverLine4: "🦀 क्या तुम मेरे साथ अतीत और भविष्य की धाराओं में यात्रा के लिए तैयार हो?",
    ...
    perfectScore: "उत्तम! आप अद्भुत हैं! 🌟",
    wellDone: "बहुत अच्छे! लगे रहो! 💪",
    excellentWork: "उत्कृष्ट कार्य! 🏆",
    almostThere: "लगभग पहुँच गए! फिर से कोशिश करो! 🤔",
    goodTry: "अच्छी कोशिश! अगला प्रयास करो! 👏",
    keepPracticing: "अभ्यास करते रहो! 🎧",
    nextTimeBetter: "अगली बार बेहतर होगा! 💯",
    dontGiveUp: "हार मत मानो! 🚀",

    soundTestEchoDialogAhoy: "🌬️ प्रणाम, युवा नाविक...",
    soundTestEchoDialogIntro: "मैं हूँ गूंजऋषि — प्रतिध्वनियों का श्रोता। 🐚👂",
    soundTestEchoDialogIsleDescription:
      "तुम गूँज टापू पर पहुँच गए हो, जो फुसफुसाने वाला द्वीप है... जहाँ हर आवाज़ में एक राज़ है। 🌫️✨",
    soundTestEchoDialogTwoSounds: "मैं तुम्हें दो ध्वनियाँ सुनाऊँगा... 🎧🎧",
    soundTestEchoDialogYourJob:
      "तुम्हारा काम है ध्यान से सुनना और मुझे बताना...",
    soundTestEchoDialogAreTheySame: "क्या वे एक जैसी थीं? ✅",
    soundTestEchoDialogOrDifferent: "या अलग थीं? ❌",
    soundTestEchoDialogReadyPirate:
      "अपनी आँखें बंद करो, अपने कान खोलो... क्या तुम अपनी इस सुरीली यात्रा के लिए तैयार हो? 🌀👦👧",

    altSirEchoTheCrab: "सर इको केकड़ा",

    buttonPlayingAudio: "चल रहा है...",
    buttonPlayAudio: "ऑडियो चलाएँ",
    labelListeningCarefully: "ध्यान से सुन रहे हैं...",
    soundTestApiName: "टेस्ट 16: ध्वनि भेद",
    imReadysound: "🌬️ मेरे कान खुले हैं और मैं तैयार हूँ।",
    ...
    transcribingInProgress: "ट्रांसक्राइब हो रहा है...",
    uploadAudioPrompt: "या एक ऑडियो फ़ाइल अपलोड करें",
    instructionsButtonLabel: "निर्देश",
    ...
    yourAnswerColumn: "आपका उत्तर",
    correctAnswerColumn: "सही उत्तर",
    altQuestionImage: "प्रश्न की छवि",
    takeNewTestButton: "नया टेस्ट दें",
    orSeparatorText: "या",
    statusProcessing: "संसाधित हो रहा है...",
    ...
    practiceResultCorrect: "अभ्यास: बहुत बढ़िया! आपने इसे सही पहचाना।",
    practiceResultIncorrect: "अभ्यास: अच्छी कोशिश!",
    answerCouldNotSeeImage: "छवि नहीं देख पाए।",

    pictureTestResultsTitle: "परिणाम",

    loadingResultsText: "परिणाम लोड हो रहे हैं...",
    pictureTestResultsTitle: "परिणाम",
    tableHeaderImage: "छवि",
    tableHeaderUserAnswer: "उपयोगकर्ता का उत्तर",
    tableHeaderCorrectAnswer: "सही उत्तर",
    tableHeaderScore: "स्कोर",
    tableHeaderDescription: "विवरण",
    tableHeaderFeedback: "प्रतिक्रिया",
    noImagePlaceholder: "कोई छवि नहीं",
    ...
    you_said: "आपने कहा",
    correct: "सही",
    not_quite_try_next: "पूरी तरह सही नहीं! चलिए अगला प्रयास करते हैं।",
    lets_try_next_one: "चलिए अगला प्रयास करते हैं!",
    challenge_complete: "चुनौती पूरी हुई",
    forward_score: "सीधा स्कोर",
    ...
    forwardSequences: "सीधे क्रम",
    reverseSequences: "उल्टे क्रम",
    accuracy: "सटीकता",
    ...
    rewardsTitle: "आपके पुरस्कार",
    rewardEarned: "आपने एक पुरस्कार जीता है!",
    memoryMasterTrophy: "मेमोरी मास्टर ट्रॉफी",
    returnToResults: "परिणामों पर वापस लौटें",
  ...
  kn: {
    ...
    riverLine1: "🐚 ನಮಸ್ಕಾರ, ಯುವ ಪ್ರವಾಸಿಗನೇ! ನಾನು ಕಾಲನಾಥ, ಕಾಲದ ನದಿಯನ್ನು ಕಾಯುವ ಕೆಂಗುಲು.",
    riverLine2: "🌊 ಇಲ್ಲಿ ನದಿ ಕೇವಲ ಸ್ಥಳದಿಂದಲ್ಲ, ಭೂತಕಾಲ ಮತ್ತು ಭವಿಷ್ಯದ ಕ್ಷಣಗಳ ಮೂಲಕ ಹರಿಯುತ್ತದೆ.",
    riverLine3: "⏳ ನಿನ್ನ ಸವಾಲು ಎಂದರೆ ಕಾಲದ ಘಟನೆಗಳನ್ನು ಸರಿಯಾದ ಕ್ರಮದಲ್ಲಿ ಒಗಡಿಸುವುದು.",
    riverLine4: "🦀 ನನ್ನೊಂದಿಗೆ ಭೂತ ಮತ್ತು ಭವಿಷ್ಯದ ಹರಿವಿನಲ್ಲಿ ಪ್ರಯಾಣಿಸಲು ತಯಾರಿದೆಯಾ?",
    mystaraLine1: "🔮 ನಮಸ್ಕಾರ, ಯುವ ಅನ್ವೇಷಕ! ನಾನು ಮಿಸ್ಟಾರಾ, ಪ್ರಾಚೀನ ಸಂಕೇತಗಳ ಕಾಪಾಡುವವಳು.",
    mystaraLine2: "✨ ಈ ರಹಸ್ಯಮಯ ಚಿಹ್ನೆಗಳು ಸ್ಮೃತಿ ಮತ್ತು ಏಕಾಗ್ರತೆಯ ಶಕ್ತಿಯನ್ನು ಹೊಂದಿವೆ.",
    mystaraLine3: "🌟 ನಿನ್ನ ಗುರಿ ಎಂದರೆ ಈ ಪವಿತ್ರ ಕ್ರಮಗಳನ್ನು ಗಮನದಿಂದ ನೋಡಿ ಅವುಗಳನ್ನು ನಿಖರವಾಗಿ ಪುನರಾವರ್ತನೆ ಮಾಡುವುದು.",
    mystaraLine4: "🎭 ನೀನು ಸಂಕೇತ ಲೋಕದ ರಹಸ್ಯಗಳನ್ನು ತೆರೆದುಕೊಳ್ಳಲು ಸಿದ್ಧನಾಗಿದ್ದೀಯಾ?",
    question: "ಪ್ರಶ್ನೆ",
    complete: "ಪೂರ್ಣ",
    mainMenu: "ಮುಖ್ಯ ಮೆನು",
    ...
    excellentWork: "ಅತ್ಯುತ್ತಮ ಕೆಲಸ! 🏆",
    almostThere: "ಸುಮಾರು ಸರಿ ಇದೆ! ಮತ್ತೊಮ್ಮೆ ಪ್ರಯತ್ನಿಸಿ! 🤔",
    goodTry: "ಒಳ್ಳೆಯ ಪ್ರಯತ್ನ! ಮುಂದಿನದನ್ನು ಪ್ರಯತ್ನಿಸಿ! 👏",
    keepPracticing: "ಅಭ್ಯಾಸ ಮುಂದುವರಿಸಿ! 🎧",
    nextTimeBetter: "ಮುಂದಿನ ಬಾರಿ ಉತ್ತಮ! 💯",
    dontGiveUp: "ಬಿಟ್ಟುಕೊಡಬೇಡಿ! 🚀",

    soundTestEchoDialogAhoy: "🌬️ ನಮಸ್ಕಾರ, ಯುವ ಯಾತ್ರಿಕರೇ...",
    ...
    soundTestEchoDialogOrDifferent: "ಅಥವಾ ವಿಭಿನ್ನವಾಗಿದ್ದವೇ? ❌",
    soundTestEchoDialogReadyPirate:
      "ಕಣ್ಣು ಮುಚ್ಚಿ, ಕಿವಿ ತೆರೆಯಿರಿ... ನಿಮ್ಮ ಈ ನಾದದ ಪ್ರಯಾಣವನ್ನು ಪ್ರಾರಂಭಿಸಲು ಸಿದ್ಧರಿದ್ದೀರಾ? 🌀👦👧",

    altSirEchoTheCrab: "ಸರ್ ಎಕೋ ಏಡಿ",

    buttonPlayingAudio: "ಪ್ಲೇ ಆಗುತ್ತಿದೆ...",
    buttonPlayAudio: "ಆಡಿಯೋ ಪ್ಲೇ ಮಾಡಿ",
    labelListeningCarefully: "ಗಮನವಿಟ್ಟು ಕೇಳಲಾಗುತ್ತಿದೆ...",
    soundTestApiName: "ಟೆಸ್ಟ್ 16: ಶಬ್ದ ವ್ಯತ್ಯಾಸ",
    ...
    buttonTryAgain: "ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ",
    buttonProceedToMainTest: "ಮುಖ್ಯ ಪರೀಕ್ಷೆಗೆ ಮುಂದುವರಿಯಿರಿ",
    buttonSubmitDemoAnswer: "ಡೆಮೊ ಉತ್ತರವನ್ನು ಸಲ್ಲಿಸಿ",
    recordingInProgress: "ರೆಕಾರ್ಡಿಂಗ್ ಆಗುತ್ತಿದೆ...",
    transcribingInProgress: "ಲಿಪ್ಯಂತರ ಮಾಡಲಾಗುತ್ತಿದೆ...",
    uploadAudioPrompt: "ಅಥವಾ ಆಡಿಯೊ ಫೈಲ್ ಅಪ್‌ಲೋಡ್ ಮಾಡಿ",
    instructionsButtonLabel: "ಸೂಚನೆಗಳು",
    demoReadTheseWords: "ದಯವಿಟ್ಟು ಈ ಪದಗಳನ್ನು ಕ್ರಮವಾಗಿ ಗಟ್ಟಿಯಾಗಿ ಓದಿ:",
    ...
    practiceRoundTitle: "ಅಭ್ಯಾಸ ಸುತ್ತು",
    finishPractice: "ಅಭ್ಯಾಸ ಸುತ್ತನ್ನು ಸಲ್ಲಿಸಿ",
    gotItButton: "ತಿಳಿಯಿತು!",
    ...
    pictureTestProgressBarTitle: "ಪರೀಕ್ಷೆಯ ಪ್ರಗತಿ",
    pictureTestProgressStatus: "{total} ರಲ್ಲಿ {current} ಪೂರ್ಣಗೊಂಡಿದೆ",

    speakGreatWhatIsIt: "ಅದ್ಭುತ! ಅದು ಏನು ಎಂದು ಹೇಳಬಲ್ಲಿರಾ?",
    speakCanYouSeeThisPictureInitial: "ನೀವು ಈ ಚಿತ್ರವನ್ನು ನೋಡಬಹುದೇ?",
    ...
    loadingResultsText: "ಫಲಿತಾಂಶಗಳನ್ನು ಲೋಡ್ ಮಾಡಲಾಗುತ್ತಿದೆ...",
    pictureTestResultsTitle: "ಫಲಿತಾಂಶಗಳು",
    tableHeaderImage: "ಚಿತ್ರ",
    tableHeaderUserAnswer: "ಬಳಕೆದಾರರ ಉತ್ತರ",
    tableHeaderCorrectAnswer: "ಸರಿಯಾದ ಉತ್ತರ",
    tableHeaderScore: "ಅಂಕ",
    tableHeaderDescription: "ವಿವರಣೆ",
    tableHeaderFeedback: "ಪ್ರತಿಕ್ರಿಯೆ",
    noImagePlaceholder: "ಚಿತ್ರ ಇಲ್ಲ",
    ...
    listen_carefully: "ಗಮನವಿಟ್ಟು ಕೇಳಿ...",
    your_turn_say_numbers: "ನಿಮ್ಮ ಸರದಿ! ನೀವು ಕೇಳಿದ ಸಂಖ್ಯೆಗಳನ್ನು ಹೇಳಿ.",
    your_turn_say_numbers_backwards: "ನಿಮ್ಮ ಸರದಿ! ಸಂಖ್ಯೆಗಳನ್ನು ಹಿಂದಕ್ಕೆ ಹೇಳಿ.",
    ...
    yourScore: "ನಿಮ್ಮ ಅಂಕ",
    forwardSequences: "ನೇರ ಅನುಕ್ರಮಗಳು",
    reverseSequences: "ವಿಲೋಮ ಅನುಕ್ರಮಗಳು",
    accuracy: "ನಿಖರತೆ",
    viewRewards: "ನಿಮ್ಮ ಬಹುಮಾನಗಳನ್ನು ವೀಕ್ಷಿಸಿ",
    ...
    rewardsTitle: "ನಿಮ್ಮ ಬಹುಮಾನಗಳು",
    rewardEarned: "ನೀವು ಬಹುಮಾನವನ್ನು ಗೆದ್ದಿದ್ದೀರಿ!",
    memoryMasterTrophy: "ಮೆಮೊರಿ ಮಾಸ್ಟರ್ ಟ್ರೋಫಿ",
    returnToResults: "ಫಲಿತಾಂಶಗಳಿಗೆ ಹಿಂತಿರುಗಿ",
