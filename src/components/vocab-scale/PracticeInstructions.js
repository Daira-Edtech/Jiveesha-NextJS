  ...
  const instructions = [
    {
      ...
      description:
        "We'll show you a word on the screen. Read it carefully and think about what it means.",
      title_ta: "சொல்லைக் கேளுங்கள்",
      description_ta:
        "நாங்கள் உங்களுக்கு ஒரு சொல்லைக் காட்டுவோம். அதை கவனமாகப் படித்து அதன் பொருளைப் பற்றி யோசியுங்கள்.",
      title_hi: "शब्द को सुनें",
      description_hi:
        "हम आपको स्क्रीन पर एक शब्द दिखाएंगे। इसे ध्यान से पढ़ें और सोचें कि इसका क्या मतलब है।",
    },
    {
      icon: <Type className="h-6 w-6" />,
      title: "Type Your Answer",
      description:
        "Type what you think the word means in the text box. Don't worry about perfect spelling!",
      title_ta: "உங்கள் பதிலைத் தட்டச்சு செய்யுங்கள்",
      description_ta:
        "சொல்லின் பொருள் என்னவென்று நீங்கள் நினைக்கிறீர்களோ அதை உரைப்பெட்டியில் தட்டச்சு செய்யுங்கள். சரியான எழுத்துப்பிழை பற்றி கவலைப்பட வேண்டாம்!",
      title_hi: "अपना उत्तर टाइप करें",
      description_hi:
        "आपको लगता है कि शब्द का क्या मतलब है, उसे टेक्स्ट बॉक्स में टाइप करें। सही स्पेलिंग की चिंता न करें!",
    },
    {
      icon: <Mic className="h-6 w-6" />,
      title: "Or Speak Your Answer",
      description:
        "You can also click the microphone button and speak your answer out loud!",
      title_ta: "அல்லது உங்கள் பதிலைச் சொல்லுங்கள்",
      description_ta:
        "நீங்கள் மைக்ரோஃபோன் பொத்தானைக் கிளிக் செய்து உங்கள் பதிலை உரக்கச் சொல்லலாம்!",
      title_hi: "या अपना उत्तर बोलें",
      description_hi:
        "आप माइक्रोफोन बटन पर क्लिक करके अपना उत्तर जोर से भी बोल सकते हैं!",
    },
    {
      icon: <CheckCircle className="h-6 w-6" />,
      title: "Get Feedback",
      description:
        "We'll tell you if your answer is correct and help you if you need it!",
      title_ta: "கருத்துக்களைப் பெறுங்கள்",
      description_ta:
        "உங்கள் பதில் சரியானதா என்று நாங்கள் உங்களுக்குச் சொல்வோம், தேவைப்பட்டால் உங்களுக்கு உதவுவோம்!",
      title_hi: "प्रतिक्रिया प्राप्त करें",
      description_hi:
        "हम आपको बताएंगे कि आपका उत्तर सही है या नहीं और यदि आपको इसकी आवश्यकता है तो आपकी सहायता करेंगे!",
    },
  ];
