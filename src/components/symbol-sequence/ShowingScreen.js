...
// components/symbol-sequence/ShowingScreen.js

import { motion } from "framer-motion"
import { symbols } from "./symbolSequenceConstants"

const ShowingScreen = ({ currentSequence, currentRound, totalRounds, showingIndex, timeToView, t }) => {
  return (
    <motion.div
      ...
      >
            ...
            >
              <motion.div
                ...
                style={{
                  ...
                  boxShadow:
                    showingIndex === index ? "0 0 30px rgba(217, 162, 75, 0.9)" : "0 0 15px rgba(217, 162, 75, 0.5)",
                  color: "#f7f1e3",
                  textShadow:
                    showingIndex === index ? "0 0 20px rgba(247, 241, 227, 0.9)" : "0 0 10px rgba(247, 241, 227, 0.7)",
                }}
                animate={{
        ...
        <div className="w-4/5 mx-auto bg-[#1a2a3a]/30 rounded-full h-5 overflow-hidden">
          <motion.div
            ...
            initial={{ width: "100%" }}
            animate={{ width: "0%" }}
            transition={{ duration: timeToView / 1000, ease: "linear" }}
          />
        </div>
