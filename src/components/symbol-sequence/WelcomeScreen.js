...
// components/symbol-sequence/WelcomeScreen.js

import { motion } from "framer-motion"
import { symbols, difficultyLevels } from "./symbolSequenceConstants"
    ...
    <motion.div className="fixed inset-0 flex items-center justify-center p-4 z-10">
      ...
      >
        ...
        <motion.div className="relative">
          ...
          <p className="text-[#f7f1e3]/90 mb-8 leading-relaxed text-2xl">{t("symbolSequenceDescription")}</p>
        </motion.div>
            ...
            {difficultyLevels.map((level, index) => (
              ...
              >
                ...
                <span className="relative z-10 text-[#f7f1e3] tracking-wider flex flex-col items-center">
                  <span className="text-3xl mb-1">{symbols[index + 5]}</span>
