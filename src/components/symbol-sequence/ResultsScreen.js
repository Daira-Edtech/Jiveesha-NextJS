...
// app/(your-main-app-route)/symbol-sequence-test/components/ResultsScreen.js
'use client';
import React from 'react';
import { motion } from 'framer-motion';

const ResultsScreen = ({ feedback, userSequence, currentSequence, currentRound, onContinue, t }) => {
  return (
    <motion.div
      ...
      >
        ...
        <motion.h2
          className={`text-4xl font-bold mb-12 tracking-wider ${
            feedback.includes(t('correct')) ? 'text-[#f3c969]' : 'text-[#d9a24b]'
          }`}
          initial={{ y: -20 }}
          animate={{ y: 0 }}
          style={{
