        ...
        <AnimatePresence mode="wait">
                ...
                >
                  ...
                  >
                    <div className="relative z-10">
                      ...
                      <h3 className="text-xl font-semibold mb-2 text-gray-800">
                        {t("individualAssessment")}
                      </h3>
                      <p className="text-gray-600 text-sm leading-relaxed">
                        {t("individualAssessmentDescription")}
                      </p>
                    </div>
                  </motion.button>
                  ...
                  >
                    <div className="relative z-10">
                      ...
                      <p className="text-gray-600 text-sm leading-relaxed">
                        {t("continuousAssessmentDescription")}
                      </p>
                    </div>
                  </motion.button>
                </motion.div>
          ...
          {showStartScreen && (
            ...
            >
              ...
              />
              <motion.div className="absolute inset-0 flex items-end justify-end p-8">
                <motion.button
                  initial={{ scale: 0.9, opacity: 0 }}
                  animate={{
                    scale: [0.9, 1.1, 1],
